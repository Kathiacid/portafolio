...
import "./Skills.css";
// Importaciones corregidas (asegúrate que coincidan los nombres)
import CVButton from "../assets/cv-button.png";
import MinkiShelterImage from "../assets/Minki-shelter.jpg"; // Cambiado de .webp a .png
import CalicoYaImage from "../assets/calico-ya.webp";

export default function Skills() {
return (
<div className="skills-page">
    {/* Sección superior con saludo y descripción */}
    ...
    {/* Sección de habilidades en 2 columnas como en la imagen */}
